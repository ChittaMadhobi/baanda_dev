...
class BaandaLibrary extends Component {
  ...
  onSubmit(e) {
    ...
    // Call getDFResponse
    console.log('onSubmit Q:' + this.state.question);
    if (!this.getDFResponse(this.state.question)) {
  ...
  render() {
    ...
    // if (this.state.start) {
    //   console.log('errors render: ' + JSON.stringify(this.state));
    //   console.log('errors.name : ' + errors.name);
    //console.log('answer (in render): ' + answer);
    // }
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-8 m-auto">
              <h1 className="display-4 text-center">The Library</h1>
